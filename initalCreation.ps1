New-xDscResource –Name ContainerDeployment -Property @(
    ...
    New-xDscResourceProperty –Name SlackWebHook –Type String  –Attribute Key
    New-xDscResourceProperty –Name ProjectType –Type String  –Attribute Key -ValidateSet 'sample-golang','iis'
